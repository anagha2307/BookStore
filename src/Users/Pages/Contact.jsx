      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 grid-cols-1 mx-10 p-10 md:gap-0 gap-10">
          <div className="flex items-center gap-3">
              <FontAwesomeIcon icon={faLocationDot} className='text-black text-2xl bg-gray-300 px-3 py-3 rounded-full' />
              <h1>123 Main Street, Apt 4B, Anytown, CA 91324</h1>
          </div>
          <div className="flex items-center gap-3">
              <FontAwesomeIcon icon={faPhone} className='text-black text-2xl bg-gray-300 px-3 py-3 rounded-full' />
              <h1>+ 91   9876543210</h1>
          </div>
          <div className="flex items-center gap-3">
              <FontAwesomeIcon icon={faEnvelopeOpen} className='text-black text-2xl bg-gray-300 px-3 py-3 rounded-full' />
              <h1>Bookstore@gmail.com</h1>
          </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 m-10 p-10">
          <form action="" className='bg-gray-400 p-3 rounded'>
            ...
            <input type="textarea" placeholder='Message'className="w-full bg-white p-2 rounded placeholder-gray-500 focus:outline-none text-gray-600 my-2"/>

              <button className="bg-blue-950 p-2 w-full rounded text-white mb-0">Send</button>
          </form>
          <div>
