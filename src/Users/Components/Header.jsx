  ...
  return (
    <>
      ...
      <div className='grid grid-cols-3 md:p-3 p-1 '>
        ...
        <div className='flex md:justify-end items-center md:m-1 m-15 space-x-1 text-xl'>
      ...
      <nav className='w-full bg-blue-950 text-white p-2'>
        ...
        <ul className={listStatus ? 'block text-lg space-y-4 my-2' : 'md:flex justify-center items-center hidden p-2'}>
